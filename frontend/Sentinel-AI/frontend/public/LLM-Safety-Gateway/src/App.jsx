...
//   { to: "/overall", label: "Overall", icon: BarChart3 },
...
//     ? "bg-[#160020] text-[#f7ecff]"
//     : "bg-[#fef9ff] text-[#210024]";

//   return (
//     <BrowserRouter>
//       <div
//         className={`min-h-screen flex flex-col transition-colors duration-300 ${rootClasses}`}
//       >
...
// /* ---------- NAVBAR (SAME LOOK AS YOUR REFERENCE) ---------- */
...
//     : "bg-[#3c0044] text-white shadow-[0_0_16px_rgba(60,0,68,0.35)]";
//   const inactiveClasses = isDark
//     ? "text-white/90 hover:text-white hover:bg-white/10"
//     : "text-[#f7ecff] hover:text-white hover:bg-[#4f0a61]";

//   const headerBg = isDark ? "bg-[#3c0044]" : "bg-[#5b0c6f]";
...
//   return (
//     <header
//       className={`sticky top-0 z-40 border-b ${headerBorder} ${headerBg} bg-opacity-95`}
//     >
...
//           <button
//             onClick={toggleTheme}
//             className="inline-flex items-center gap-2 px-3 py-2 rounded-full text-xs font-semibold border border-white/40 text-white hover:bg-white/10"
//           >
//             {theme === "dark" ? (
//               <>
...
//           <button
//             onClick={toggleTheme}
//             className="inline-flex h-8 w-8 items-center justify-center rounded-full border border-white/40 text-white"
//           >
//             {theme === "dark" ? (
//               <SunMedium className="h-4 w-4" />
//             ) : (
...
import { AnimatePresence, motion } from "framer-motion";
import { useEffect, useState } from "react";
import { Home as HomeIcon, Activity, BarChart3, GitBranch, Moon, Sun } from "lucide-react";
